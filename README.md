...
Import [`tests/postman/OpenG2P-Audit-Manager.postman_collection.json`](tests/postman/OpenG2P-Audit-Manager.postman_collection.json)
...
Nine JSON fixtures under [`tests/sample-events/`](tests/sample-events/)
...
See [`config/default.yaml`](config/default.yaml) for the full reference. Top-level keys:
